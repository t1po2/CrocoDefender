package main.java.com.crocodefender.core;

import main.java.com.crocodefender.entities.enemies.*;
import main.java.com.crocodefender.entities.projectiles.*;
import main.java.com.crocodefender.entities.towers.*;
import main.java.com.crocodefender.maps.*;
    ...
    public void placeTower(Point p) {
        ...
        switch (selectedTower) {
            case "basic_tower":
                ...
                newTowerStats = new main.java.com.crocodefender.entities.towers.BasicT();
                break;
            case "sniper_tower":
                newTowerStats = new main.java.com.crocodefender.entities.towers.SniperT();
                break;
            case "duck_tower":
                newTowerStats = new main.java.com.crocodefender.entities.towers.DuckT();
                break;
            case "tank_tower":
                newTowerStats = new main.java.com.crocodefender.entities.towers.TankT();
                break;
            case "strong_duck":
                newTowerStats = new main.java.com.crocodefender.entities.towers.StrongDuckT();
                break;
            case "coca_farm":
                newTowerStats = new main.java.com.crocodefender.entities.towers.CocaFarm();
                break;
            default:
                newTowerStats = new main.java.com.crocodefender.entities.towers.BasicT();
    ...
    public void saveGameHighscore() {
        ...
        javax.swing.SwingUtilities.invokeLater(() -> {
            ...
            if (gamePanel != null) {
                ...
                new main.java.com.crocodefender.ui.MainMenu(); // Öffnet das Hauptmenü neu
            }
        });
    }
