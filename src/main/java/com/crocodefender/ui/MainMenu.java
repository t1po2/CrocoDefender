package main.java.com.crocodefender.ui;
...
import main.java.com.crocodefender.Launcher;
 ...
 * @see main.java.com.crocodefender.Launcher
 * @see main.java.com.crocodefender.score.HighScoreManager
...
public class MainMenu extends JFrame {
    ...
    private void loadAndDisplayHighscores() {
        ...
        main.java.com.crocodefender.score.HighScoreManager hm = new main.java.com.crocodefender.score.HighScoreManager();
        ArrayList<main.java.com.crocodefender.score.HighScoreEntry> scores = hm.getScores();
        ...
        if (scores.isEmpty()) {
            ...
            for (int i = 0; i < limit; i++) {
                main.java.com.crocodefender.score.HighScoreEntry entry = scores.get(i);
